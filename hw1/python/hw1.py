...
def main():
    ...
    drawFunctionPlot(
        [mx, mx2, mx3, mx4, mx5],
        "Relationship between number of points and mean X",
        "Mean X",
        1)

    drawFunctionPlot(
        [my, my2, my3, my4, my5],
        "Relationship between number of points and mean Y",
        "Mean Y",
        2)

    drawFunctionPlot(
        [mz, mz2, mz3, mz4, mz5],
        "Relationship between number of points and mean Z",
        "Mean Z",
        3)

    # Standard deviation
    drawFunctionPlot(
        [stdx, stdx2, stdx3, stdx4, stdx5],
        "Relationship between number of points and S.D. X",
        "Standard deviation X",
        4)
    drawFunctionPlot(
        [stdy, stdy2, stdy3, stdy4, stdy5],
        "Relationship between number of points and S.D. Y",
        "Standard deviation Y",
        5)
    drawFunctionPlot(
        [stdz, stdz2, stdz3, stdz4, stdz5],
        "Relationship between number of points and S.D. Z",
